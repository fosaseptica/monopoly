...
public class Avatar {
    ...
    * - Un arraylist de los avatares ya creados, con el objetivo de evitar que se generen dos ID iguales.
    ...
    public String toString() {
        String jugadorNombre = (jugador != null ? jugador.getNombre() : "-");
        String lugarNombre = (lugar != null ? lugar.getNombre() : "-");
        String tipoStr = (tipo != null ? tipo : "-");
        String idStr = (id != null ? id : "-");
        return "id: " + idStr + ", tipo: " + tipoStr + ", jugador: " + jugadorNombre + ", casilla: " + lugarNombre;
    }
}
