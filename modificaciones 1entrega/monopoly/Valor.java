...
public class Valor {
    ...
    public static final float SUMA_VUELTA = 1301328.584f; // Cantidad que recibe un jugador al pasar pos la Salida
     // CORREGIR estos valores según el enunciado
    public static final float FORTUNA_INICIAL = 15000000f; // 15M€
    public static final float PAGO_SALIDA = 2000000f; // 2M€ por pasar salida
    public static final float PRECIO_CARCEL = 500000f; // 500K€ para salir
